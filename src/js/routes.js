...
angular.module('VivoDash').config(['$stateProvider', '$urlRouterProvider',
    function($stateProvider, $urlRouterProvider) {
        ...
        $stateProvider
            ...
            .state('dashboards_explore', {
                url: '/dashboards_explore',
                templateUrl: 'templates/MenuDashboards/dashboards_explore.html'
            })
            .state('security_summary', {
                url: '/security_summary',
                templateUrl: 'templates/MenuSecurity/security_summary.html'
            })
            .state('security_setting', {
                url: '/security_setting',
                templateUrl: 'templates/MenuSecurity/security_setting.html'
            })
            .state('audit_log_summary', {
                url: '/audit_log_summary',
                templateUrl: 'templates/MenuAuditLog/audit_log_summary.html'
            });
    }
]);
